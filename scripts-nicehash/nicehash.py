...
class private_api:
    ...
    def get_accounting_transactions(self, currency='BTC', size=11, page=0):
        params = "size={}&page={}".format( size, page)
        page_path = '/main/api/v2/accounting/transactions/' + currency

        return self.request('GET', page_path, params, None)
